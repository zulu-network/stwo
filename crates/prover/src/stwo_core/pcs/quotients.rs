...
use crate::stwo_core::backend::cpu::quotients::{accumulate_row_quotients, quotient_constants};
...
use crate::stwo_core::fri::SparseCircleEvaluation;
...
use crate::stwo_core::queries::SparseSubCircleDomain;
...
mod tests {
    ...
    use crate::stwo_core::pcs::quotients::{compute_fri_quotients, PointSample};
