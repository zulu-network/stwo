...
use crate::stwo_core::fri::{fold_circle_into_line, fold_line, FriOps};
...
impl CpuBackend {
    ...
    ///
    /// [`CirclePoly`]: crate::stwo_core::poly::circle::CirclePoly
...
mod tests {
    ...
    use crate::stwo_core::poly::circle::{CanonicCoset, SecureEvaluation};
    use crate::m31;
