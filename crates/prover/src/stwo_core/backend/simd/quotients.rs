...
use crate::stwo_core::backend::cpu::quotients::{
    batch_random_coeffs, column_line_coeffs, QuotientConstants,
};
use crate::stwo_core::backend::{Col, Column};
...
use crate::stwo_core::fields::FieldOps;
...
/// See [crate::stwo_core::constraints::point_vanishing_fraction] for more details.
