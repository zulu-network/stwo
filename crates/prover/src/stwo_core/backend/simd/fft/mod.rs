...
use crate::stwo_core::fields::m31::P;
...
fn mul_twiddle(v: PackedBaseField, twiddle_dbl: u32x16) -> PackedBaseField {
    ...
    cfg_if::cfg_if! {
        if #[cfg(all(target_feature = "neon", target_arch = "aarch64"))] {
            ...
            crate::stwo_core::backend::simd::m31::_mul_doubled_neon(v, twiddle_dbl)
        } else if #[cfg(all(target_feature = "simd128", target_arch = "wasm32"))] {
            crate::stwo_core::backend::simd::m31::_mul_doubled_wasm(v, twiddle_dbl)
        } else if #[cfg(all(target_arch = "x86_64", target_feature = "avx512f"))] {
            crate::stwo_core::backend::simd::m31::_mul_doubled_avx512(v, twiddle_dbl)
        } else if #[cfg(all(target_arch = "x86_64", target_feature = "avx2f"))] {
            crate::stwo_core::backend::simd::m31::_mul_doubled_avx2(v, twiddle_dbl)
        } else {
            crate::stwo_core::backend::simd::m31::_mul_doubled_simd(v, twiddle_dbl)
        }
    }
}
