...
use crate::stwo_core::backend::{ColumnOps, CpuBackend};
use crate::stwo_core::circle::{CirclePoint, Coset, CosetIterator};
...
use crate::stwo_core::fields::{ExtensionOf, FieldExpOps, FieldOps};
...
mod tests {
    ...
    use crate::stwo_core::fields::m31::BaseField;
    use crate::stwo_core::poly::line::{LineEvaluation, LinePoly};
